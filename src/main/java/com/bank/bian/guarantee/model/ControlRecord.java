package com.bank.bian.guarantee.model;
...
/**
 * The BIAN control record for this service domain: "Guarantee Facility Fulfillment Arrangement".
 *
 ...
 * to its asset type (Guarantee Facility). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Guarantee Facility Fulfillment Arrangement";
